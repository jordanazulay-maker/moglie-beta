<div style="text-align: center; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif;">
  ...
  <p style="font-size: 1.2em; max-width: 600px; margin: 0 auto 20px auto; line-height: 1.5;">
    ...
    Moglie monitors your WAN status and security state to let you know if the pack is safe or if he's lost his connection.<br>You are on Moglie's Beta channel! The link below sends you to Moglie's laitest stable release!
  </p>
...
<div style="max-width: 800px; margin: 0 auto; line-height: 1.6;">
  ...
  <p><i>(Psst... no matter the status, if it's between your configured <code>night Moglie will get his pjs on!
